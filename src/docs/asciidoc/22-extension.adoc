...
The `exec` extension property accepts a Closure or Provider which delegates to the http://bmuschko.github.io/gradle-docker-plugin/api/com/bmuschko/gradle/docker/DockerJavaApplication.CompositeExecInstruction.html[DockerJavaApplication.CompositeExecInstruction] subset of the http://bmuschko.github.io/gradle-docker-plugin/api/com/bmuschko/gradle/docker/tasks/image/Dockerfile.html[Dockerfile task].
