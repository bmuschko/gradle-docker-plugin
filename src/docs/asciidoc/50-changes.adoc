...
* Change source and target compatibility of plugin to Java 11
* Correct method signature of `Dockerfile.addFile(Dockerfile.File file)` - {uri-github}/issues/990[Issue 990]
