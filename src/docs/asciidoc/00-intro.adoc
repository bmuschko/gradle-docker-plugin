...
[IMPORTANT]
This plugin requires Gradle >= 5.2 to work properly. Due to an incompatibility in Docker Java, running the plugin with Java 11 or higher does currently not work.
