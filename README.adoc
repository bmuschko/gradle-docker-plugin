...
image:https://img.shields.io/badge/groovydoc-latest-9cf["Groovydoc", link="https://bmuschko.github.io/gradle-docker-plugin/current/api/"]
...
* Skim the https://bmuschko.github.io/gradle-docker-plugin/current/user-guide/#change_log[release notes].
