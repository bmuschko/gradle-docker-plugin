...
image:https://img.shields.io/badge/stackoverflow-gradle--docker--plugin-orange["Stackoverflow", link="https://stackoverflow.com/questions/tagged/gradle-docker-plugin"]
