...
We'll be atttending!!! We've created an link:https://github.com/bmuschko/gradle-docker-plugin/issues/774[ISSUE] if you guys want to let us know you're going or you can ping us on link:https://gitter.im/gradle-docker-plugin/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge[gitter].
