...
|=======
|Type                                                                                                                                                                             |Description
|link:http://bmuschko.github.io/gradle-docker-plugin/docs/groovydoc/com/bmuschko/gradle/docker/tasks/container/extras/DockerExecStopContainer.html[DockerExecStopContainer] |Shut down container with cmd and if that does not succeed in time issue stop request.
