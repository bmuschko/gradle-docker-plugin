...
image:https://badges.gitter.im/Join%20Chat.svg["Gitter", link=".svg)](https://gitter.im/gradle-docker-plugin?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge"]
