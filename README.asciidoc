...
[Vagrant](https://www.vagrantup.com/) image with the proper setup to bootstrap a Docker installation. The
[Vagrantfile](https://github.com/bmuschko/gradle-docker-plugin/blob/master/vagrant/Vagrantfile) can be found under
...
An installation of VirtualBox and Vagrant is required. See the ["Getting Started"](https://www.vagrantup.com/docs/getting-started/)
