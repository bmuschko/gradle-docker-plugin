...
|link:http://bmuschko.github.io/gradle-docker-plugin/docs/groovydoc/com/bmuschko/gradle/docker/tasks/container/DockerWaitForLogMesageInContainer.html[DockerWaitForLogMesageInContainer]     |Blocks until container log contains specified string.
|=======
